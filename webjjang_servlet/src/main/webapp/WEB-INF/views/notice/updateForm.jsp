	...
	<form action="update.do" method="post">
		...
		<table class="table">
			...
			<tr>
				<th>게시일</th>
				<td>
	                <input id="startDate" name="startDate" required class="form-control datepicker" autocomplete="off"
	                value="${vo.startDate }">
	            </td>
			</tr>
			<tr>
				<th>종료일</th>
				<td>
	                <input id="endDate" name="endDate" required class="form-control datepicker" autocomplete="off"
	                value="${vo.endDate }">
	            </td>
			</tr>
			<tr>
