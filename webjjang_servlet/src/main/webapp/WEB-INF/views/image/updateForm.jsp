...
<div class="container">
	<h1>이미지 게시판 글수정</h1>
	 <div class="alert alert-danger">
	    ...
	    이미지는 이미지게시판 보기 화면에서 이미지 안에 바꾸기 버튼을 사용하세요.
	  </div>
	<form action="update.do" method="post">
		...
		<div class="form-group">
			...
			<input id="no" name="no" class="form-control" value = "${vo.no }" readonly>
		  </div>
		...
		<div class="form-group">
		  ...
		  <div class="form-group">
			...
			rows="7" placeholder="첫글자는 공백문자나 줄바꿈을 입력할 수 없습니다.">${vo.content }
			</textarea>
		  </div>
